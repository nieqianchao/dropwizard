...
* To setup the h2 database run.
        ...
        java -jar target/dropwizard-example-1.3.0-rc4-SNAPSHOT.jar db migrate example.yml

* To run the server run.

        java -jar target/dropwizard-example-1.3.0-rc4-SNAPSHOT.jar  server example.yml
